    ...
    )
{
    ...
    // what is this? communicate with driver?
    // according to the MS doc: "Sends a control code directly to a specified device driver, causing the corresponding device to perform the corresponding operation"
    printf("\nPress entrt to trigger thread creation\n");
    getchar();
    bRc = DeviceIoControl ( hDevice,
                            (DWORD) IOCTL_SIOCTL_METHOD_BUFFERED,   // this is the control code
                            &InputBuffer,
