...
--*/
{
    ...
    pnpPowerCallbacks.EvtDevicePrepareHardware = udfEvtDevicePrepareHardware;
    ...
    if (NT_SUCCESS(status)) {
        ...
        if (NT_SUCCESS(status)) {
            ...
            //
            status = udfQueueInitialize(device);
        }
    }
